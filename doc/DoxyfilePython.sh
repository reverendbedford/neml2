...
#---------------------------------------------------------------------------
# Configuration options related to the HTML output for Python bindings
#---------------------------------------------------------------------------
HTML_OUTPUT            = html/python
FILE_PATTERNS          = *.pyi
EXTENSION_MAPPING      = pyi=Python
WARN_LOGFILE           = /home/thu/projects/neml2/doc/doxygen.python.log
LAYOUT_FILE            = /home/thu/projects/neml2/doc/config/DoxygenLayoutPython.xml
