...
template <typename T> struct is_state : std::false_type {};
template <> struct is_state<BatchedScalar> : std::true_type {};
template <> struct is_state<BatchedSymR2> : std::true_type {};
