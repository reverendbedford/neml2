                                    ...
                                    LabeledMatrix * dout_din) const
{
  ...
  auto total_strain = in.slice(0, "forces").get<SymR2>(rate ? "total_strain_rate" : "total_strain");
  auto plastic_strain =
  ...
  // Set the output
  out.slice(0, "state").set(elastic_strain, rate ? "elastic_strain_rate" : "elastic_strain");
