...
#include "AssociativeInelasticHardening.h"
#include "InelasticModel.h"
#include "IntegratedRateFormModel.h"
#include "J2IsotropicYieldSurface.h"
#include "LinearIsotropicHardening.h"
#include "NewtonNonlinearSolver.h"
#include "PerzynaInelasticFlowRate.h"
...
TEST_CASE("Uniaxial strain regression test for Perzyna model", "[StructuralRegressionTests]")
{
  ...
  torch::load(forces_ref, name + "_forces.pt");
  auto states_ref = torch::zeros_like(driver.states());
  torch::load(states_ref, name + "_states.pt");
