...
TEST_CASE("Regression test on perfect viscoplasticity", "[perfect_viscoplasticity]")
{
  ...
  std::ofstream ofile;
  std::string fname = "regression/models/solid_mechanics/perfect_viscoplasticity";
